...
'-XYZ' is used to denote 3-axial signals each direction.
...
### The following variables are observation identifiers. The data set is in long format
- activity: factor variable denoting the activity classified: WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING

- subject: subject identifier with a range of 1 to 30
